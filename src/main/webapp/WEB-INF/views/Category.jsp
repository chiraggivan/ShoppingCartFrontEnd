...
${msg}
	...
	<c:url var="addAction" value="/manag_category_add"></c:url>
	...
	<table>
		...
		<tr>
			...
			<input type="submit" value="<spring:message text="Update category"/> "/>	</c:if>
				<c:if test="${!empty category.name}">
			<input type="submit" value="<spring:message text="Add category"/> "/>	</c:if>
			</td>
		</tr>
	</table>
	</form:form>
